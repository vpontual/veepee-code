...
const COMMANDS: CommandDef[] = [
  ...
  { name: '/extras', args: '', description: 'List built-in language bundles (TypeScript, Python, Go, Rust)' },
  { name: '/extras add', args: '<name>', description: 'Install an extras bundle (LSP + formatter hook + prompt section)' },
  { name: '/extras remove', args: '<name>', description: 'Remove an extras bundle (unregisters its hooks; LSP servers stay)' },
  { name: '/doctor', args: '', description: 'Audit dev environment (proxy, fleet, LSP binaries, hooks, MCP, etc.)' },
  { name: '/doctor fix', args: '[id]', description: 'Apply available auto-fixes (or one specific fix by id)' },
  { name: '/lsp', args: '', description: 'List configured LSP servers and their status' },
  { name: '/lsp install', args: '[language...]', description: 'Install LSP server(s) for the project (auto-detects when no args)' },
