...
const COMMANDS: CommandDef[] = [
  ...
  { name: '/hooks', args: '', description: 'List configured hooks (global + project)' },
  { name: '/hooks trust', args: '', description: 'Trust this project\'s .veepee/settings.json hooks' },
  { name: '/hooks deny', args: '', description: 'Block this project\'s hooks from running' },
  { name: '/skills', args: '', description: 'List available skills (lazy-loaded markdown)' },
  { name: '/mcp', args: '', description: 'List configured MCP servers and their tools' },
  { name: '/output-style', args: '[name]', description: 'List or switch output style (default/explanatory/learning + custom)' },
  { name: '/agents', args: '', description: 'List spawned subagents (running + recent)' },
  { name: '/agents output', args: '<id>', description: 'Fetch a subagent\'s result (blocks if running)' },
  { name: '/agents stop', args: '<id>', description: 'Abort a running subagent' },
  ...
  { name: '/rc', args: '', description: 'Show Remote Connect status, QR code, and URL' },
