...
14 tools:
  ...
  edit_file            Edit a file by replacing a string match...
  github               Interact with GitHub via the gh CLI...
  ...
```

If a remote agent bridge is configured, remote tools appear here too with a `[remote]` prefix in their descriptions.
